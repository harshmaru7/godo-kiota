...
// FirewallsItemTagsRequestBuilder builds and executes requests for operations under \v2\firewalls\{firewall_id}\tags
type FirewallsItemTagsRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// FirewallsItemTagsRequestBuilderDeleteRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type FirewallsItemTagsRequestBuilderDeleteRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// FirewallsItemTagsRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type FirewallsItemTagsRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
}
// NewFirewallsItemTagsRequestBuilderInternal instantiates a new FirewallsItemTagsRequestBuilder and sets the default values.
func NewFirewallsItemTagsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FirewallsItemTagsRequestBuilder) {
    m := &FirewallsItemTagsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/v2/firewalls/{firewall_id}/tags", pathParameters),
    }
    return m
}
// NewFirewallsItemTagsRequestBuilder instantiates a new FirewallsItemTagsRequestBuilder and sets the default values.
func NewFirewallsItemTagsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FirewallsItemTagsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewFirewallsItemTagsRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *FirewallsItemTagsRequestBuilder) WithUrl(rawUrl string)(*FirewallsItemTagsRequestBuilder) {
    return NewFirewallsItemTagsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
